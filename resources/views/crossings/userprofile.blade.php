        ...
        <div class="profile_page_content">
            ...
            <div class="photos_section">
                ...
                <div class="photo-uploads hidden">
                    <a href="{{$user->setting->instagram ? '/getPhotos/instagram' : '#'}}" class="button button-instagram-photos" {{$user->setting->instagram ? 'style="color:lightgrey"' : null}} {{$user->setting->instagram ? null : 'disabled'}}>Get instagram photos</a>
